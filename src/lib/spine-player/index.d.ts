...
declare module spine.webgl {
  class ManagedWebGLRenderingContext {
    ...
    private restorables;
    constructor(
      canvasOrContext: HTMLCanvasElement | WebGLRenderingContext | EventTarget | WebGL2RenderingContext,
      contextConfig?: any,
    );
    private setupCanvas;
...
declare module spine {
  ...
  interface SpinePlayerConfig {
    ...
    onCalculateAnimationViewport: (viewport: { x: number; y: number; width: number; height: number }) => void;
  }
  class SpinePlayer {
    ...
    context: webgl.ManagedWebGLRenderingContext;
    ...
    currentViewport: SpinePlayerConfig['viewport'];
    private previousViewport;
    private viewportTransitionStart;
    private selectedBones;
    private parent;
    private stopRequestAnimationFrame;
    constructor(parent: HTMLElement | string, config: Partial<SpinePlayerConfig>);
    validateConfig(config: Partial<SpinePlayerConfig>): Partial<SpinePlayerConfig>;
